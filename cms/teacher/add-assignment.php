...
$allowed_extensions = array(".docs",".doc",".pdf",".docx");
if(!in_array($extension,$allowed_extensions))
{
echo "<script>alert('File has Invalid format. Only docs / doc/ pdf / docx format allowed');</script>";
}
else
{
...
<head>
    ...
    <title>CMS: Add Assignment </title>
                                ...
                                <div class="col-md-6">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="txtDate" min="<?php echo date("Y-m-d"); ?>" class="form-control border-none input-flat bg-ash" name="lsdate" required="true">
                                        </div>                                     
                                    </div>
                                </div>
                                <div class="col-md-6">
