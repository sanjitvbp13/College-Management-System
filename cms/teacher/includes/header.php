<div class="header">
        <div class="pull-left">
            <div class="logo"><a href="dashboard.php"><!-- <img src="../assets/images/logo.png" alt="" /> --><span>CMS Teacher</span></a></div>
...
foreach($results as $row)
{               ?>
                <li class="header-icon dib"><img class="avatar-img" src="../assets/images/avatar/images (1).png" alt="" /> <span class="user-avatar"><span class="badge badge-success badge-indicator"> <?php  echo $row->FirstName;?> <i class="ti-angle-down f-s-10"></i></span>
