...
<head>
    ...
    <title>CMS : Teacher Details</title>
...
$sql="SELECT tblcourse.ID,tblcourse.BranchName,tblcourse.CourseName,tblteacher.ID,tblteacher.TeacherID,tblteacher.FirstName,tblteacher.LastName,tblteacher.MobileNumber,tblteacher.Email,tblteacher.Gender,tblteacher.Dob,tblteacher.CourseID,tblteacher.Experience,tblteacher.Address,tblteacher.Password,tblteacher.ProfilePic,tblteacher.JoiningDate from tblteacher join tblcourse on tblcourse.ID=tblteacher.CourseID where tblteacher.ID=$tid";
...
<span class="phone-number"><?php  echo htmlentities($row->Experience);?></span>
 </div>
