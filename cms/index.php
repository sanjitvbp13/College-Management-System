			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.php"><span class="fa fa-check-square-o" aria-hidden="true"></span>government polytechnic college </a></h1>
					</div>
					<!-- navigation -->
...
{               ?>
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls">
				<h2><a href="index.php"><span class="fa fa-check-square-o" aria-hidden="true"></span>College Management System</a></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	<div class="copyright-w3layouts">
		<div class="container">
			<p>&copy; 2022 CMS. College Management System (CMS) | </p>
		</div>
	</div>
	<!-- //Footer -->
