...
// allowed extensions
$allowed_extensions = array(".docs",".pdf",".doc",".docx");
// Validation for allowed extensions .in_array() function searches an array for a specific value.
if(!in_array($extension,$allowed_extensions))
{
echo "<script>alert('Answer has Invalid format. docs,doc,docx and pdf format allowed');</script>";
}
else
{
...
<head>
    ...
    <title>CMS : Submit Assignment </title>
