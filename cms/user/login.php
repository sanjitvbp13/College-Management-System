                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="../index.php"><span>CMS User</span></a>
                        </div>
                        <div class="login-form">
                            ...
                            <form method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Roll Number or Mobile Number" maxlength="10" pattern="[0-9]+" required="true" name="rollmobilenum">
                                </div>
                                <div class="form-group">
