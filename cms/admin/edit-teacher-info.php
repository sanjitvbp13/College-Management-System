...
$eid=$_GET['editid'];
$sql="update tblteacher set FirstName=:fname,LastName=:lname,MobileNumber=:mobnum,Email=:email,Gender=:gender,Dob=:dob,CourseID=:cid,Experience=:experience,Address=:address where tblteacher.ID=:eid";
...
<head>
    ...
    <title>CMS : Update Teacher Information </title>
                    ...
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="" enctype="multipart/form-data">
                                <?php
                                    $eid=$_GET['editid'];
$sql="SELECT tblcourse.ID as cid,tblcourse.BranchName,tblcourse.CourseName,tblteacher.ID,tblteacher.TeacherID,tblteacher.FirstName,tblteacher.LastName,tblteacher.MobileNumber,tblteacher.Email,tblteacher.Gender,tblteacher.Dob,tblteacher.CourseID,tblteacher.Experience,tblteacher.Address,tblteacher.Password,tblteacher.ProfilePic,tblteacher.JoiningDate from tblteacher join tblcourse on tblcourse.ID=tblteacher.CourseID where tblteacher.ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" name="teaid" readonly="true" value="<?php  echo htmlentities($row->TeacherID);?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" name="experience" required="true" value="<?php  echo htmlentities($row->Experience);?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
