...
$ret="select Email from tblteacher where Email=:email || MobileNumber=:mobnum || TeacherID=:teaid";
...
$sql="insert into tblteacher(TeacherID,FirstName,LastName,MobileNumber,Email,Gender,Dob,CourseID,Experience,Address,Password,ProfilePic)values(:teaid,:fname,:lname,:mobnum,:email,:gender,:dob,:cid,:experience,:address,:password,:propic)";
...
echo "<script>alert('Email-id,Teacher Id or Mobile Number already exist. Please try again');</script>";
}
}
}
?>
...
<head>
    ...
    <title>CMS : Add Teacher Information </title>
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control"  name="dob" required="true" min="1980-01-01" max="1997-01-01">
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" name="teaid" maxlength="5" pattern="[0-9]+" required="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" name="experience" required="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
